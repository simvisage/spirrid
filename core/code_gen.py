...
class CodeGen(HasStrictTraits):
    '''
        ...
        of the class. 
    '''
    # backward link to the core object
    core = WeakRef
    ...
    #===========================================================================
    # Propagate the change to the core
    #===========================================================================
    @on_trait_change('+codegen_option')
    def set_codegen_option_changed(self):
        self.core.codegen_option = True

if __name__ == '__main__':

    from core import SPIRRID
    from core_lab import Heaviside
