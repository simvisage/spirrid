...
class PDistrib(HasTraits):
    ...
    def __init__(self, **kw):
        ...
        self.on_trait_change(
            self.refresh, 'distr_type.changed,quantile,n_segments')
        self.refresh()
    ...
    distr_choice = Enum('sin2x', 'weibull_min', 'sin_distr',
                        'uniform', 'norm', 'piecewise_uniform', 'gamma')
